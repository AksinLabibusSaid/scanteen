...
<main class="flex-1 flex flex-col px-4 pt-6 pb-[105px] gap-6">
    ...
    <div class="flex flex-col gap-3">
        ...
        <div class="flex flex-col gap-3">
            ...
            <!-- Midtrans -->
            <button type="button" class="payment-option group flex items-center justify-between w-full p-6 rounded-3xl bg-white transition-all border border-[#F5F5F4] opacity-70 shadow-[0_4px_20px_0_rgba(0,0,0,0.04)] cursor-pointer hover:shadow-[0_6px_24px_0_rgba(0,0,0,0.08)]" data-method="midtrans">
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 bg-[#E5E2DD] transition-colors">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M4 6h16v12H4V6zm2 2v8h12V8H6zm2 2h8v2H8v-2zm0 3h5v2H8v-2z" fill="#5F5E5B"/></svg>
                    </div>
                    <div class="flex flex-col items-start text-left">
                        <span class="text-sm font-semibold text-[#1A1C1A] leading-[16.8px] tracking-[0.7px]">
                            Kartu / E-Wallet (Midtrans)
                        </span>
                        <span class="text-xs text-[#5F5E5B] leading-[19.2px] mt-0.5">
